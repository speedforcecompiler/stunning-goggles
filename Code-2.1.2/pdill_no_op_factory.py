...
def notify_email(kwargs):
    ...
    recipient_emails=['prashanth.desani@wellsfargo.com','Venkateswara.R.Akula2@wellsfargo.com']
...
dag = DAG('pdill_datamasking_job', schedule_interval=None, catchup=False,default_args=default_args)
